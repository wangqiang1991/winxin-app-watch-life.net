...
Page({
  ...
  onLoad: function (options) {
   ...
   args.cateType='all';  
   Adapter.loadCategories(args,that,API,false);
  ...
  publishArticle:function (e) {
   ...
   // console.log(that.data.args.content);
    ...
    if (!that.data.args.excerpt || that.data.args.excerpt.trim()==''  || that.data.args.excerpt.trim().length==0) {
    ...
    if (that.data.args.excerpt.trim().length >500) {
    ...
    var data={
        ...
        category: categoryId,
        excerpt: that.data.args.excerpt,
        userid:userId,
        sessionid:sessionId,
        tags:tags,
        formid:formId,
